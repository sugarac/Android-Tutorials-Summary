...
4. > * Add RecyclerView dependency into gradle file \(how?\)
   ...
   [CardView](https://github.com/codepath/android_guides/wiki/Using-the-CardView), [Navigation Drawer & Toolbar](https://www.gitbook.com/book/sugarac/android-tutorials-summary/edit#)

5. ViewHolder类将xml每个控件的id绑定到Java对象
...
10. [Supporting Multiple Screens\(支持Android各种屏幕尺寸\)](http://blog.csdn.net/wzy_1988/article/details/52932875)
11. android:background="?attr/selectableItemBackground" 指定有界的波纹
12. .view.MainActivity 是MainActivity类所在位置
